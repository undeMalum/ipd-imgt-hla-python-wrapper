...
async def fetch_all_alleles_from_query(client: httpx.AsyncClient, query: str) -> AllelesNames:
    results = []
...
async def download_alleles(
    client: httpx.AsyncClient, query: str, seq_type: SequenceTypes = SequenceTypes.GENOMIC
) -> AllelesSequences:
